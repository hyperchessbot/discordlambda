...
const defaultCommiterName =
  "hyperchessbot" || process.env.OCTOKIT_COMMITER_NAME;
const defaultCommiterEmail =
  "hyperchessbot@gmail.com" || process.env.OCTOKIT_COMMITER_EMAIL;
const defaultAuthorName =
  defaultCommiterName || process.env.OCTOKIT_AUTHOR_NAME;
const defaultAuthorEmail =
  defaultCommiterEmail || process.env.OCTOKIT_AUTHOR_EMAIL;
